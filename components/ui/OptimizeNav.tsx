 ...
 * All steps are unclickable; only 'Title' is active.
 */
const OptimizeNav: React.FC = () => {
  return (
    <nav className="w-full flex justify-center mt-4">
      <ul className="flex gap-4 bg-white/60 rounded-full px-2 py-1 shadow-md">
        <li>
          <span
            className="px-6 py-2 rounded-full font-semibold bg-gradient-to-r from-orange-400 to-pink-500 text-white shadow transition-all"
          >
            Title
          </span>
        </li>
        <li>
          <span
            className="px-6 py-2 rounded-full font-semibold text-gray-400 bg-gray-100 cursor-not-allowed opacity-60 select-none"
            aria-disabled="true"
          >
            Bullet Points
          </span>
